...
from q2b_learn import extractSift, computeHistograms, writeHistogramsToFile
...
writeHistogramsToFile(nclusters,all_files_labels,fnames,all_word_histgrams,HISTOGRAMS_FILE)

print("---------------------")
print("## test data with svm")
print("label {}".format(libsvm.test(HISTOGRAMS_FILE, model_file)))
